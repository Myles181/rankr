...
export default function ArtistDashboard() {
  ...
  useEffect(() => {
    // Mock session for now if API fails
    ...
    /* Real fetch logic commented out until backend is ready
    ...
    <div className="dashboard-layout">
      ...
      <main className="main">
        ...
        <div className="content">
          {!session?.artistVerified && (
            <div className="verify-banner" id="verifyBanner">
      ...
      {/* CREATE POOL MODAL */}
      <div className={`modal-overlay ${isModalOpen ? 'open' : ''}`} id="modalOverlay" onClick={(e) => { if(e.target === e.currentTarget) setIsModalOpen(false) }}>
        <div className="modal">
